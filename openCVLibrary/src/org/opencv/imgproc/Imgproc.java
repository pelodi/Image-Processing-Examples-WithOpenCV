...
public class Imgproc {
    ...
    //
    // C++:  void cv::HoughLines(Mat image, Mat& line_picture, double rho, double theta, int threshold, double srn = 0, double stn = 0, double min_theta = 0, double max_theta = CV_PI)
    //

    //javadoc: HoughLines(image, line_picture, rho, theta, threshold, srn, stn, min_theta, max_theta)
    ...
    //javadoc: HoughLines(image, line_picture, rho, theta, threshold, srn, stn, min_theta)
    ...
    //javadoc: HoughLines(image, line_picture, rho, theta, threshold, srn, stn)
    ...
    //javadoc: HoughLines(image, line_picture, rho, theta, threshold, srn)
    ...
    //javadoc: HoughLines(image, line_picture, rho, theta, threshold)
    ...
    //
    // C++:  void cv::HoughLinesP(Mat image, Mat& line_picture, double rho, double theta, int threshold, double minLineLength = 0, double maxLineGap = 0)
    //

    //javadoc: HoughLinesP(image, line_picture, rho, theta, threshold, minLineLength, maxLineGap)
    ...
    //javadoc: HoughLinesP(image, line_picture, rho, theta, threshold, minLineLength)
    ...
    //javadoc: HoughLinesP(image, line_picture, rho, theta, threshold)
