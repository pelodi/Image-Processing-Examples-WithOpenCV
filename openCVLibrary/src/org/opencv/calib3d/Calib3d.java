...
public class Calib3d {
    ...
    //
    // C++:  void cv::computeCorrespondEpilines(Mat points, int whichImage, Mat F, Mat& line_picture)
    //

    //javadoc: computeCorrespondEpilines(points, whichImage, F, line_picture)
